                ...
                <div class="card">
                    <div class="card-body">
                        <form action="../inc/insert.include.php" method="post">
                            ...
                            <input type="text" name="amount" class="form-control mt-2" id="" placeholder="Enter transaction amount">
                            <input type="date" name="transaction_date" class="form-control mt-2" id="" placeholder="">
